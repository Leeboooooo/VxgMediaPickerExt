...
public class FirstActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fix_media).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.outside_bs_btn:
                ...
                break;
            case R.id.fix_media:
                BoxingConfig fixConfig = new BoxingConfig(BoxingConfig.Mode.MEDIA).needGif();
                Boxing.of(fixConfig).withIntent(this, BoxingActivity.class).start(this, REQUEST_CODE);
                break;
            default:
                break;
        }
